...
const pullups = [
  ...
  ["R2", "SDA4", 8, -17.144, 0, -3.4, -4],
  ["R3", "SCL4", 8, -15.62, 0, -2.3, -4],
  ["R13", "SDA5", 8, -6.984, 0, -3.4, -1.6],
  ["R14", "SCL5", 8, -5.46, 0, -2.3, -1.6],
  ["R15", "SDA6", 8, 3.176, 0, -3.4, 0.8],
  ["R16", "SCL6", 8, 4.7, 0, -2.3, 0.8],
  ["R17", "SDA7", 8, 13.336, 0, -3.4, 3.2],
  ["R18", "SCL7", 8, 14.86, 0, -2.3, 3.2],
] as const
...
export default () => (
  <board width="35.56mm" height="54.61mm" layers={2}>
    <schematicsection name="Main" displayName="Main" />
    <schematicsection name="Ports" displayName="Qwiic Connectors" />
    <schematicsection name="Mux" displayName="I2C Multiplex" />
    <schematictext
      text="Clear JP4 to remove"
      schX={10.4}
      schY={7.25}
      fontSize={0.18}
      color="gray"
    ...
    />
    <schematictext
      text="main I2C pull-up resistors."
      schX={10.4}
      schY={6.9}
      fontSize={0.18}
      color="gray"
    ...
    />
    <schematictext
      text="Default 7-bit I2C address: 0x70"
      schX={10.4}
      schY={-0.1}
      fontSize={0.18}
      color="gray"
    ...
    />
    <schematictext
      text="Set ADR jumpers below when"
      schX={10.4}
      schY={-0.45}
      fontSize={0.18}
      color="gray"
    ...
    />
    <schematictext
      text="using multiple multiplexers."
      schX={10.4}
      schY={-0.8}
      fontSize={0.18}
      color="gray"
    ...
    <schematictable
      ...
      cellPadding={0.08}
    >
      <schematicrow height={0.34}>
        <schematiccell text="I2C Address" width={1.7} />
        <schematiccell text="ADR2" width={0.95} />
        <schematiccell text="ADR1" width={0.95} />
        <schematiccell text="ADR0" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x70 (default)" width={1.7} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Open" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x71" width={1.7} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x72" width={1.7} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Open" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x73" width={1.7} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x74" width={1.7} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Open" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x75" width={1.7} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Open" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x76" width={1.7} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Open" width={0.95} />
      </schematicrow>
      <schematicrow height={0.34}>
        <schematiccell text="0x77" width={1.7} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
        <schematiccell text="Closed" width={0.95} />
      </schematicrow>
