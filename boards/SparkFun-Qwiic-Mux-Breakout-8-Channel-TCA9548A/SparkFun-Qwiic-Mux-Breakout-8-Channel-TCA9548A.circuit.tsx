...
const qwiicPorts = [
  { name: "J1", sda: "SDA0", scl: "SCL0", x: -12.7, y: 13.334, r: -90, sx: -13.4, sy: 2.4 },
  { name: "J8", sda: "SDA1", scl: "SCL1", x: -12.7, y: 3.174, r: -90, sx: -13.4, sy: 0 },
  { name: "J9", sda: "SDA2", scl: "SCL2", x: -12.7, y: -6.986, r: -90, sx: -13.4, sy: -2.4 },
  { name: "J10", sda: "SDA3", scl: "SCL3", x: -12.7, y: -17.146, r: -90, sx: -13.4, sy: -4.8 },
  { name: "J23", sda: "SDA4", scl: "SCL4", x: 12.699, y: -17.145, r: 90, sx: -6.4, sy: -4.8 },
  { name: "J24", sda: "SDA5", scl: "SCL5", x: 12.699, y: -6.985, r: 90, sx: -6.4, sy: -2.4 },
  { name: "J25", sda: "SDA6", scl: "SCL6", x: 12.699, y: 3.175, r: 90, sx: -6.4, sy: 0 },
  { name: "J26", sda: "SDA7", scl: "SCL7", x: 12.699, y: 13.335, r: 90, sx: -6.4, sy: 2.4 },
]
...
export default () => (
  ...
  >
    ...
    <schematictext text="Main" schX={-11} schY={8} fontSize={0.27} color="gray" anchor="center" />
    <schematictext text="Qwiic Connectors" schX={-11} schY={5} fontSize={0.27} color="gray" anchor="center" />
    <schematictext text="I2C Multiplex" schX={6} schY={7} fontSize={0.27} color="gray" anchor="center" />
