...
export default () => {
    return (
        <board width={22} height={22}>
            ...
            />
            <netlabel net="V3_3" schX={6} schY={2} connectsTo={sel.U2.VCC} anchorSide="bottom" />

            <netlabel net="GND" schX={0} schY={-10} connectsTo={sel.J1.GND} anchorSide="top" />
            <netlabel net="V3_3" schX={1} schY={-10} connectsTo={sel.J1.V3_3} anchorSide="bottom" />
