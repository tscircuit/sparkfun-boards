  ...
  <board width="17.78mm" height="40.64mm">
    <CD74HC4067
      ...
      connections={{
        ...
        CHAN8: sel.net().CHAN8,
        CHAN9: sel.net().CHAN9,
        CHAN10: sel.net().CHAN10,
        CHAN11: sel.net().CHAN11,
        CHAN12: sel.net().CHAN12,
        CHAN13: sel.net().CHAN13,
        CHAN14: sel.net().CHAN14,
        CHAN15: sel.net().CHAN15,
    ...
    <jumper
      ...
      connections={{
        ...
        pin9: sel.net().CHAN8,
        pin10: sel.net().CHAN9,
        pin11: sel.net().CHAN10,
        pin12: sel.net().CHAN11,
        pin13: sel.net().CHAN12,
        pin14: sel.net().CHAN13,
        pin15: sel.net().CHAN14,
        pin16: sel.net().CHAN15,
      }}
    />
