...
export const SparkFunMicroModRP2040 = () => (
  <board width="22mm" height="22mm">
    ...
    {/* Row 1 */}
    <capacitor name="C1" capacitance="2.2uF" footprint="0402" schX={-40} schY={50} connections={{ pin1: net.V3V3, pin2: net.GND }} />
    <capacitor name="C2" capacitance="0.1uF" footprint="0402" schX={-30} schY={50} connections={{ pin1: net.V3V3, pin2: net.GND }} />
