...
export default () => (
    <board width="22mm" height="22mm">
        ...
        <jumper
            ...
            schPinArrangement={{
                leftSide: {
                    ...
                    pins: ["GND", "3V3", "USB_D-", "USB_D+", "RESET", "BOOT", "I2C_SDA", "I2C_SCL", "SPI_CIPO", "SPI_COPI", "SPI_SCK", "SPI_CS", "UART_TX1", "UART_RX1"],
                },
                rightSide: {
                    direction: "top-to-bottom",
                    pins: ["A0", "A1", "D0", "D1", "G0", "G1", "G2", "G3", "G4", "G5", "G6", "SWDIO", "SWCLK"],
                },
            }}
        />
        ...
        <capacitor name="C2" capacitance="100nF" footprint="0402" pcbX={3} pcbY={3} />
        <capacitor name="C3" capacitance="1uF" footprint="0402" pcbX={-3} pcbY={7} />
        <capacitor name="C4" capacitance="10uF" footprint="0402" pcbX={3} pcbY={7} />

        {/* Net labels for power */}
        <netlabel net="GND" schX={-10} schY={-5} anchorSide="right" connectsTo={sel.J1.pin1} />
        <netlabel net="VCC" schX={-10} schY={-3} anchorSide="right" connectsTo={sel.J1.pin3} />
