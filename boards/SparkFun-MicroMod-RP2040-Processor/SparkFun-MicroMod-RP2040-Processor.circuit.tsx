...
export const SparkFunMicroModRP2040 = () => (
  <board width="22mm" height="22mm">
    ...
    <resistor
      ...
      pcbRotation="180deg"
      layer="bottom"
      connections={{ pin1: net.ADC_VDD, pin2: net.V3V3 }}
    />
    <resistor
      name="R4"
      resistance="10k"
    ...
    <resistor
      ...
      pcbRotation="180deg"
      layer="bottom"
      connections={{ pin1: net.GND, pin2: net.USB_MUX_SIG }}
    />
    <resistor
      name="R9"
      resistance="1k"
      ...
      pcbRotation="90deg"
      layer="bottom"
      connections={{ pin1: net.QSPI_SS, pin2: net.BOOT }}
    />
    <resistor
      name="R10"
      resistance="27"
      ...
      pcbRotation="0deg"
      layer="bottom"
      connections={{ pin1: net.RP_DP, pin2: net.USB_DP }}
    />
    <resistor
      name="R11"
      resistance="27"
      ...
      pcbRotation="0deg"
      layer="bottom"
      connections={{ pin1: net.RP_DN, pin2: net.USB_DN }}
    />
    <resistor
      name="R18"
      resistance="1k"
      ...
      pcbRotation="0deg"
      layer="bottom"
      connections={{ pin1: net.USB_VIN, pin2: net.USB_MUX_SIG }}
    />
