...
export const FS3000_1015 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C3662658.obj?uuid=4bc563325fb3498794e51402b6f7f101",
        stepUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/assets/C3662658.step?uuid=4bc563325fb3498794e51402b6f7f101",
        pcbRotationOffset: 0,
        modelOriginPosition: {
